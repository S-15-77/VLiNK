    ...
    return Column(
      children: [
        ...
        Container(
          ...
          child: TextField(
            onChanged: (val) {
              Provider.of<addValues>(context, listen: false).addName(val);
            },
            controller: name,
        ...
        Container(
          ...
          child: TextField(
            onChanged: (val) {
              Provider.of<addValues>(context, listen: false).addEmail(val);
            },
            controller: email,
            decoration: InputDecoration(
                border: OutlineInputBorder(
        ...
        Container(
          ...
          child: TextField(
            onChanged: (val) {
              Provider.of<addValues>(context, listen: false).addPhone(val);
            },
            controller: phoneno,
            decoration: InputDecoration(
                border: OutlineInputBorder(
