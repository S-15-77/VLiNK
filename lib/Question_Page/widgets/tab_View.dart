...
class TabView extends StatefulWidget {
  TabView({required this.flagged, required this.answered});
  final List flagged;
  final List answered;
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    Row(
                                      children: [
                                        Text(
                                          "Question - ${widget.flagged[i] + 1}                                         ${extractedData[widget.flagged[i]].mainTitle} ",
                                          style: GoogleFonts.nunito(
                                              fontWeight: FontWeight.w700,
                                              fontSize: 16),
                                        ),
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    Row(
                                      children: [
                                        Text(
                                          "Question - ${widget.answered[i] + 1}                                         ${extractedData[widget.answered[i]].mainTitle} ",
                                          style: GoogleFonts.nunito(
                                              fontWeight: FontWeight.w700,
                                              fontSize: 16),
                                        ),
